...
organizations, mostly with large firm-, transaction- and person-level microdata.
...
{% for pub in site.data.publications.refereed_journals %}{% include pub-entry.html pub=pub %}{% endfor %}

## Discussion papers and work in progress

{% for pub in site.data.publications.discussion_papers %}{% include pub-entry.html pub=pub %}{% endfor %}

## Publications beyond economics

{% for pub in site.data.publications.publications_beyond_economics %}{% include pub-entry.html pub=pub %}{% endfor %}
